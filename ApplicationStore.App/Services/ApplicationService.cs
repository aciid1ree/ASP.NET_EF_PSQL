...
namespace ApplicationStore.App.Services
{
    public class ApplicationService : IApplicationService
    {
        ...
        public async Task<Guid> UpdateApplications(Guid id, string name, string title, string descripton, string outline)
        {
        ...
        public async Task<List<Guid>> GetSubmittedApplications(DateTime submit)
        {
        ...
        public async Task<List<Guid>> GetSubmitOlderApplications(DateTime submit)
        {
